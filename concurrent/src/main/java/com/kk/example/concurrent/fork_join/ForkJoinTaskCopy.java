package com.kk.example.concurrent.fork_join;
...
public abstract class ForkJoinTaskCopy<V> implements Future<V>, Serializable {

    volatile int status; // accessed directly by pool and workers
    static final int DONE_MASK   = 0xf0000000;  // 1111
    static final int NORMAL      = 0xf0000000;  // 1111must be negative
    static final int CANCELLED   = 0xc0000000;  // 1011must be < NORMAL
    static final int EXCEPTIONAL = 0x80000000;  // 1000must be < CANCELLED
...
//            }
    ...
    public static void main(String[] args) {
        System.out.printf("%x", 0xf0000000 >>> 16);
    }
//
//    final int doExec() {
